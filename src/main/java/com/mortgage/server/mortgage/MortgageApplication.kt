...
//        mort.insertOrUpdateLoan(0, StickyFixedRateLoanTwoAndHalfYearsChanges(304500.0, 2.9, 360))
//        mort.insertOrUpdateLoan(0, FixedRateTwoAndHalfYearsChangesLoan(168000.0, 2.325, 360, 0.0))
